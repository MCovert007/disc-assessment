...
const SignUp: React.FC = () => {
  ...
  const createUser = async () =>{
    ...
    try {
      ...
      const response = await axios.post("/api/db/users?action=create", data)
      if(response.data.message){        
        alert(response.data.message)
      }else{
        await axios.post("/api/email/magic-link", {email})        
        window.location.href = `/auth/email-verification?reg=true&email=${email}`;
      }
    } catch (error:any) {
  ...
  return (
    <div className="sign-page">
      <div className="flex justify-center items-center h-screen backdrop-blur-[4px]">
        <div className="flex flex-wrap items-center max-w-[1440px] md:min-w-[1000px] mx-auto rounded-sm bg-white shadow-defaul dark:bg-boxdark bg-opacity-90">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <span className="mt-15 inline-block flex justify-center items-center">
                <svg
                  width="350"
                  height="350"
                  viewBox="0 0 350 350"
